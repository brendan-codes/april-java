...
class SLL {
    ...
    delete(data) {
        if (this.isEmpty()) return null;            // for when SLL is empty
        if (this.head.data == data)  {              // for when head node == data
        ...
        while (runner.next) {                       // regular loop through checking for data
            if (runner.next.data == data) {
                // let remove = runner.next;
        ...
        //return;                                // for when data was not found
    }
